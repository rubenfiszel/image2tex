...
def resize(resize_size, image, display):
	if(display): print ""
        rs = str(resize_size)+"x"+str(resize_size)
	command_line = "convert "+image+" -resize " + rs + " -gravity center -background white -extent " + rs + " " + image
